...
# for example np.unique(['sample1', 'sample2', 'sample2', 'sample3']) -> ['sample1', 'sample2', 'sample3']
 ...
 # in folder evaluation/ include a folder fastq_raw/ and a folder fastq_clean/

 #Make sure you have all of the following:
 # fastq_raw #your NovaSeq raw fasq files
 ...
 # bam_damged # has downscaled bam files in case samples acuse damage patterns
...
bed_path = '/space/s1/joana/refgenomes/V.lagopus/vulpes_lagopus_scilife_genome.bed'
...
rule nbases_cov_bam_merge:
    input:
        expand('bam_merge/{sample}.flagfilt.rmdup.sorted.rg.merged.bam', sample=SAMPLES)
    output:
        'evaluation/after_merge_avgcov_bammerge.txt',
